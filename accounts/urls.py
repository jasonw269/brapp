...
urlpatterns = [
    ...
    path('profile/<int:user_id>/edit/', views.profile_edit, name='profile_edit_other'),
    ...
    path('users/<int:user_id>/password/', views.user_password_change, name='user_password_change'),
]
